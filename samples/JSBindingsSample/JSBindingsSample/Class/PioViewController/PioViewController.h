...
@property (strong, nonatomic) IBOutletCollection(UISwitch) NSArray *pinSettingSwitch;
@property (strong, nonatomic) IBOutletCollection(UISwitch) NSArray *inputPinSwitch;
@property (strong, nonatomic) IBOutletCollection(UISwitch) NSArray *outputPinSwitch;
@property (strong, nonatomic) IBOutletCollection(UISwitch) NSArray *pullupPinSwitch;
