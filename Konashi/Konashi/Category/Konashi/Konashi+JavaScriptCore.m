...
+ (instancetype)sharedInstance
{
	...
	dispatch_once(&onceToken, ^{
		...
		NSDictionary *events = @{KONASHI_EVENT_CENTRAL_MANAGER_POWERED_ON : JS_KONASHI_EVENT_CENTRAL_MANAGER_POWERED_ON,
								 KONASHI_EVENT_PERIPHERAL_NOT_FOUND : JS_KONASHI_EVENT_PERIPHERAL_NOT_FOUND,
								 KONASHI_EVENT_CONNECTED : JS_KONASHI_EVENT_CONNECTED,
								 KONASHI_EVENT_DISCONNECTED : JS_KONASHI_EVENT_DISCONNECTED,
								 KONASHI_EVENT_READY : JS_KONASHI_EVENT_READY,
								 KONASHI_EVENT_UPDATE_PIO_INPUT : JS_KONASHI_EVENT_UPDATE_PIO_INPUT,
								 KONASHI_EVENT_UPDATE_ANALOG_VALUE : JS_KONASHI_EVENT_UPDATE_ANALOG_VALUE,
								 KONASHI_EVENT_UPDATE_ANALOG_VALUE_AIO0 : JS_KONASHI_EVENT_UPDATE_ANALOG_VALUE_AIO0,
								 KONASHI_EVENT_UPDATE_ANALOG_VALUE_AIO1 : JS_KONASHI_EVENT_UPDATE_ANALOG_VALUE_AIO1,
								 KONASHI_EVENT_UPDATE_ANALOG_VALUE_AIO2 : JS_KONASHI_EVENT_UPDATE_ANALOG_VALUE_AIO2,
								 KONASHI_EVENT_I2C_READ_COMPLETE : JS_KONASHI_EVENT_I2C_READ_COMPLETE,
								 KONASHI_EVENT_UART_RX_COMPLETE : JS_KONASHI_EVENT_UART_RX_COMPLETE,
								 KONASHI_EVENT_UPDATE_BATTERY_LEVEL : JS_KONASHI_EVENT_UPDATE_BATTERY_LEVEL,
								 KONASHI_EVENT_UPDATE_SIGNAL_STRENGTH : JS_KONASHI_EVENT_UPDATE_SIGNAL_STRENGTH};
